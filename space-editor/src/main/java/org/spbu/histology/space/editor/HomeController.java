...
public class HomeController implements Initializable {
    ...
    protected final BooleanProperty pasteCellDisabledProperty = new SimpleBooleanProperty(true);
    protected final BooleanProperty pastePartDisabledProperty = new SimpleBooleanProperty(true);
    protected final BooleanProperty disableEverything = new SimpleBooleanProperty(false);
    ...
    public Node intersect(Line line1, Line line2) {
        double x, y, z;
        x = 10000;
        y = 10000;
        z = -1;
    ...
    public Node intersect3(Line line1, Line line2) {
        double x, y, z;
        x = 10000;
        y = 10000;
        z = -1;
    ...
    @ActionID(
            category = "Edit",
            id = "org.spbu.histology.menu.AB6C2"
    )
    @ActionRegistration(
    ...
    @ActionID(
            category = "Edit",
            id = "org.spbu.histology.menu.AB6C21"
    )
    @ActionRegistration(
            displayName = "#CTL_AB6C21"
    )
    ...
    @ActionID(
            category = "Edit",
            id = "org.spbu.histology.menu.A3B"
    )
    @ActionRegistration(
            displayName = "#CTL_A3B"
    )
    ...
    @ActionID(
            category = "Edit",
            id = "org.spbu.histology.menu.AB2"
    )
    @ActionRegistration(
            displayName = "#CTL_AB2"
    )
